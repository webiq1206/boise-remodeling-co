...
/** A source fact may suppress a question only after local validation, with enough confidence to price it and without an unresolved field conflict. */
...
/**
 * Ask every quantity the planning model can require before the customer reaches
 * the estimate action. The document reader can satisfy these fields first, so
 * plan sets do not create redundant questions when the quantity is already
 * supported by the uploaded source.
 */
...
const detailQuestions:Partial<Record<ScopeField,string>>={
 ...
 cabinetTallLf:'How many linear feet of tall cabinets are needed? Enter 0 if there are none.',
 garageIncluded:'Does this project include a garage?',
 ...
 laborHours:'About how many labor hours should be included?',
 ...
 flooringSqft:'About how many square feet of flooring are included?',
 tileSqft:'About how many square feet of tile are included, including wall tile or backsplash where applicable?',
 demolitionSqft:'About how many square feet of demolition are included?',
 trimLf:'About how many linear feet of trim or baseboard are included?',
};
