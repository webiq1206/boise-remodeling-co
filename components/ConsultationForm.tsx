      ...
      >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex flex-col items-end gap-1 flex-shrink-0">
                <button
                  ...
                  className="inline-flex items-center gap-1 min-h-11 lg:min-h-0 text-xs text-muted-foreground hover:text-foreground"
                ...
                <button
                  ...
                  className="inline-flex items-center min-h-11 lg:min-h-0 text-xs text-muted-foreground hover:text-foreground underline underline-offset-2"
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <button
                ...
                className="inline-flex items-center gap-1 min-h-11 lg:min-h-0 text-xs text-muted-foreground hover:text-foreground mt-1"
        ...
        {showNote ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 min-h-11 lg:min-h-0 text-xs text-muted-foreground hover:text-foreground"
