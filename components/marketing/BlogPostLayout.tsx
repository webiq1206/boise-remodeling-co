                ...
                {hub && pillarSlug && (
                  <div className="rounded-lg border border-accent/20 bg-accent/5 p-5 md:p-6 mb-8">
                    ...
                    <Link
                      ...
                      className="text-sm text-accent-legible hover:underline inline-flex items-center min-h-11 lg:min-h-0 font-normal"
                    >
                      {hub.title}
                    ...
                    {isCategoryHubIndexable(post.hubSlug, hubPosts.length) && (
                      <>
                        ...
                        <Link
                          ...
                          className="inline-flex items-center min-h-11 lg:min-h-0 text-sm text-muted-foreground hover:text-accent-legible hover:underline"
                        >
