...
export function StickyEstimateBar({
  ...
  return (
    <div
      className={cn(
        isInline
          ? "fixed left-0 right-0 pb-safe border-t bottom-0 z-[120] lg:hidden bg-background backdrop-blur-md border-border"
          : "sticky bottom-0 z-20 -mx-6 -mb-6 mt-4 border-t border-border bg-background backdrop-blur-md pb-safe md:hidden"
      )}
